...
class ReportVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "ReportTableViewCell", bundle: Bundle.main), forCellReuseIdentifier: "ReportTableViewCell")
    ...
    @IBAction func actionSegmentChages(_ sender: Any) {
...
extension ReportVC: ChartViewDelegate {
