...
class CoinsRateVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib(nibName: "CoinRateCollectionViewCell", bundle: Bundle.main), forCellWithReuseIdentifier: "CoinRateCollectionViewCell")
        tableView.register(UINib(nibName: "CoinRateTableViewCell", bundle: Bundle.main), forCellReuseIdentifier: "CoinRateTableViewCell")
...
extension CoinsRateVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "CoinRateTableViewCell", for: indexPath) as! CoinRateTableViewCell
...
extension CoinsRateVC: UITableViewDelegate {
...
extension CoinsRateVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CoinRateCollectionViewCell", for: indexPath) as! CoinRateCollectionViewCell
...
extension CoinsRateVC: UICollectionViewDelegate {
...
extension CoinsRateVC: UICollectionViewDelegateFlowLayout {
...
extension CoinsRateVC: UIScrollViewDelegate {
